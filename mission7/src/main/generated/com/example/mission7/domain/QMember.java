...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = -800198222L;
    ...
    public final DateTimePath<java.time.LocalDateTime> inactivationDate = createDateTime("inactivationDate", java.time.LocalDateTime.class);
